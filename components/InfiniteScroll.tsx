...
const Waypoint = () => {
  const { isLoading, setPage, page, paginationHandler, data } = useContext(InfiniteScrollContext);
...
const InfiniteScroll = ({ children, paginationHandler, isLoading, data }: InfiniteScrollProps) => {
