...
import { pokemonsSelector, resetPokemonsReducer } from './../features/pokemonSlice';
...
const PokemonForm = ({ placeholder, initialValue = '', changeHandler, mutatePage }: Props) => {
  const dispatch = useDispatch();
  const pokemons = useSelector(pokemonsSelector);
  const [value, setValue] = useState<string>(initialValue);
  const [selectedGeneration, setSelectedGeneration] = useState<PokemonGenerationsEnum | null>(null);
